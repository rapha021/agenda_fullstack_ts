var app = (function () {
      ...
      p(e, [n]) {
        if (15 & n) {
          ...
          for (r = e[0], o = 0; o < r.length; o += 1) {
            ...
            a[o]
              ? (a[o].p(i, n), te(a[o], 1))
              : ((a[o] = Tn(i)), a[o].c(), te(a[o], 1), a[o].m(t.parentNode, t))
          }
  ...
  function Lr(e, t, n) {
    ...
    async function ye(e) {
      if ((await G(), X))
        return Y ? Y.$set({ items: e }) : void (B && me && e.length > 0 && Se())
    }
    function ke(e) {
      const { detail: t } = e,
  ...
  return (async function () {
    const e = document.getElementById("app"),
      t = "https://rapha021.github.io/agenda_fullstack_ts/insomnia.json"
